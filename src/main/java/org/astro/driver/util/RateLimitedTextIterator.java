...
public final class RateLimitedTextIterator implements Iterator<String>, Serializable {
	...
	public static RateLimitedTextIterator bounded(final long duration,
												  final long sleepThreshold,
												  final int burstThreshold,
												  final long startTime) {
		return new RateLimitedTextIterator(true, duration, sleepThreshold, burstThreshold, startTime);
	}

	public static RateLimitedTextIterator unbounded(final long duration,
													final long sleepThreshold,
													final int burstThreshold,
													final long startTime) {
		return new RateLimitedTextIterator(false, duration, sleepThreshold, burstThreshold, startTime);
	}

	private RateLimitedTextIterator(boolean bounded,
									final long duration,
									final long sleepThreshold,
									final int burstThreshold,
									final long startTime) {
